  ...
  return (
    <HashRouter>
        <nav className="navbar navbar-expand-md navbar-dark sticky-top bg-dark">
            ...
            <a className="navbar-brand"> <i className="fa fa-search fa-lg"> </i> E-Commerce CRM </a>
            ...
            <div className="collapse navbar-collapse center" id="navbarCollapse">
                ...
                <label class="text-warning"> 
                    Welcome,  { localStorage.getItem("name") } ,<Link class="text-warning" onClick={logout}> Logout </Link>
                </label>
            </div>
        </nav>
